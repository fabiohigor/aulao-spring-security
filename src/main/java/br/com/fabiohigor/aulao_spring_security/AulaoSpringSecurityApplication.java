package br.com.fabiohigor.aulao_spring_security;
	...
	class HttpController{
		...
		String cookie(@AuthenticationPrincipal OidcUser principal) {
			return String.format("""
				...
				<h3>Authorities: %s</h3>
				<h3>JWT: %s</h3>
				""", principal,principal.getAttribute("given_name"),
					principal.getAttribute("picture"), principal.getAttribute("email"), principal.getAuthorities(),
